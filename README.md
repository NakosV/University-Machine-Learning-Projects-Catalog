...
3. A custom Cycle GAN built from scratch utilizing an Encoder-Decoder architecture that specializes in age regression and progression. **[You can click here to see it](https://github.com/NakosV/Age-Regression-And-Progression-GAN)** if you are interested.
